<template>
  <div id="app">
    <header class="header clearfix">
      <div class="container">
        <div class="logo">
          <img src="./assets/img/newlogo.png" alt="" class="logo__img">
        </div>
        <nav class="nav">
          <ul class="nav__list">
            <li class="nav__item">
    ...
    <footer class="footer">
      <div class="container">
        ...
        <div class="pskovgu-logo">
          <img src="./assets/img/pskgu-icon.png" alt="" class="pskovgu-logo__img">
        </div>
